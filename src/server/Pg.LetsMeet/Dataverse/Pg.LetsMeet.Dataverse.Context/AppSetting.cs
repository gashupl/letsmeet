...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class AppSetting : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.AppSettingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.AppSettingState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.AppSettingState), optionSet.Value)));
				}
				else
				{
					return null;

...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class EnvironmentVariableValue : Microsoft.Xrm.Sdk.Entity
	{
		...
		public Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinition environmentvariabledefinition_environmentvariablevalue
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinition>("environmentvariabledefinition_environmentvariablevalue", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinition>("environmentvariabledefinition_environmentvariablevalue", null, value);
			}
		}

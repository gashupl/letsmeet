...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class SettingDefinition : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.SettingDefinitionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.SettingDefinitionState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.SettingDefinitionState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Pg.LetsMeet.Dataverse.Context.AppUserSetting> settingdefinition_appusersetting_settingdefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Pg.LetsMeet.Dataverse.Context.AppUserSetting>("settingdefinition_appusersetting_settingdefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("settingdefinition_appusersetting_settingdefinitionid");
				this.SetRelatedEntities<Pg.LetsMeet.Dataverse.Context.AppUserSetting>("settingdefinition_appusersetting_settingdefinitionid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Pg.LetsMeet.Dataverse.Context.OrganizationSetting> settingdefinition_organizationsetting_settingdefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Pg.LetsMeet.Dataverse.Context.OrganizationSetting>("settingdefinition_organizationsetting_settingdefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("settingdefinition_organizationsetting_settingdefinitionid");
				this.SetRelatedEntities<Pg.LetsMeet.Dataverse.Context.OrganizationSetting>("settingdefinition_organizationsetting_settingdefinitionid", null, value);

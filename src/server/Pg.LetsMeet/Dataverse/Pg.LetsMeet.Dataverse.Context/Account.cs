...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.AccountState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.AccountState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.AccountState), optionSet.Value)));
				}
				else
				{
					return null;

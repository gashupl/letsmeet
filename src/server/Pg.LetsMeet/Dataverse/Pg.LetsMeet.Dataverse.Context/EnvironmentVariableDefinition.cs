...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class EnvironmentVariableDefinition : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinitionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinitionState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.EnvironmentVariableDefinitionState), optionSet.Value)));
				}
				else
				{
					return null;

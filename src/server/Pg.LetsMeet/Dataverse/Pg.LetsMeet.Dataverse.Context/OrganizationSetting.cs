...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class OrganizationSetting : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.OrganizationSettingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.OrganizationSettingState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.OrganizationSettingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Pg.LetsMeet.Dataverse.Context.SettingDefinition settingdefinition_organizationsetting_settingdefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Pg.LetsMeet.Dataverse.Context.SettingDefinition>("settingdefinition_organizationsetting_settingdefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("settingdefinition_organizationsetting_settingdefinitionid");
				this.SetRelatedEntity<Pg.LetsMeet.Dataverse.Context.SettingDefinition>("settingdefinition_organizationsetting_settingdefinitionid", null, value);

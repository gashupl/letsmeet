...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class AppModule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.AppModuleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.AppModuleState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.AppModuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Pg.LetsMeet.Dataverse.Context.AppUserSetting> appmodule_appusersetting_parentappmoduleid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Pg.LetsMeet.Dataverse.Context.AppUserSetting>("appmodule_appusersetting_parentappmoduleid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appusersetting_parentappmoduleid");
				this.SetRelatedEntities<Pg.LetsMeet.Dataverse.Context.AppUserSetting>("appmodule_appusersetting_parentappmoduleid", null, value);

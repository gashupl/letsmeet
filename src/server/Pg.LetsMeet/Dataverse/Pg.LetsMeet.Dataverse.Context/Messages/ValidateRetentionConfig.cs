...
namespace Pg.LetsMeet.Dataverse.Context
{
		...
		where T : Microsoft.Xrm.Sdk.Entity, new ()
	{
		...
		public const string ActionLogicalName = "ValidateRetentionConfig";
	...
	public partial class ValidateRetentionConfigResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		...
		public static class Fields
		{
			...
			public const string IsValidationSuccessful = "IsValidationSuccessful";
		}
		...
		public bool IsValidationSuccessful
		{
			...
			set
			{
				this.Results["IsValidationSuccessful"] = value;
			}
		}
	}
}

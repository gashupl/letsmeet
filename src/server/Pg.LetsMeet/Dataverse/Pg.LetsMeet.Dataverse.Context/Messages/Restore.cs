...
namespace Pg.LetsMeet.Dataverse.Context
{
		...
		where T : Microsoft.Xrm.Sdk.Entity, new ()
	{
		...
		{
			public const string MaintainLegacyAppServerBehavior = "MaintainLegacyAppServerBehavior";
			public const string CalculateMatchCodeSynchronously = "CalculateMatchCodeSynchronously";
			public const string Target = "Target";
			public const string SuppressDuplicateDetection = "SuppressDuplicateDetection";
			public const string ReturnRowVersion = "ReturnRowVersion";
			public const string SolutionUniqueName = "SolutionUniqueName";
		}
		
		public const string ActionLogicalName = "Restore";

...
namespace Pg.LetsMeet.Dataverse.Context
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Pg.LetsMeet.Dataverse.Context.ContactState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Pg.LetsMeet.Dataverse.Context.ContactState)(System.Enum.ToObject(typeof(Pg.LetsMeet.Dataverse.Context.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
